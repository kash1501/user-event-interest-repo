defmodule UserEventInterestWeb.EventControllerTest do
  use UserEventInterestWeb.ConnCase

  alias UserEventInterest.Events

  @create_attrs %{date: ~D[2010-04-17], description: "some description", duration: ~T[14:00:00], host: "some host", location: "some location", type: "some type"}
